...
class _GearmanWorker implements GearmanWorker {
  ...
  void setClientId(String clientId) {
    _Packet setClientId = new _Packet.createSetClientId(clientId);
    _send(setClientId);
  }
  ...
  void grabJobUniq() {
    _Packet grabjob = new _Packet.createGrabJobUniq();
    _send(grabjob); 
  }
  ...
  void cantDo(String funcName) {
    ...
    _Packet cantDo = new _Packet.createCantDo(funcName);
    _send(cantDo);
  }
